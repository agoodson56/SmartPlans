// ═══════════════════════════════════════════════════════════════
// SMARTPLANS — Server-Side Gemini API Proxy
// Hides API keys from client code, distributes across 10 key slots
// ═══════════════════════════════════════════════════════════════
...
export async function onRequestPost(context) {
    ...
    try {
        ...
        // Select API key for this brain slot — supports up to 10 keys
        const keyNames = [
        ...
        if (!apiKey) {
            return Response.json(
                { error: 'No API keys configured. Set GEMINI_KEY_0 through GEMINI_KEY_9 as secrets.' },
